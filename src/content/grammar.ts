...
import { GRAMMAR_CONCEPTS_4 } from './grammar4.ts';
import { GRAMMAR_CONCEPTS_5 } from './grammar5.ts';
import { GRAMMAR_CONCEPTS_6 } from './grammar6.ts';
import { GRAMMAR_CONCEPTS_7 } from './grammar7.ts';
import { GRAMMAR_CONCEPTS_8 } from './grammar8.ts';
import { GRAMMAR_CONCEPTS_9 } from './grammar9.ts';
import { GRAMMAR_CONCEPTS_10 } from './grammar10.ts';
...
import { GRAMMAR_CONCEPTS_15 } from './grammar15.ts';
import { GRAMMAR_CONCEPTS_16 } from './grammar16.ts';
import { GRAMMAR_CONCEPTS_17 } from './grammar17.ts';
