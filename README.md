...
Across those 57 lessons that is 473 vocabulary entries, 54 grammar concepts, 464 exercises and **1368
answer tasks** (including all twenty-two checkpoints), across 284 teaching sections,
all authored in both paths. Only 1.5% of those tasks are multiple choice; the
rest require typing German. 127 of them carry an authored trap answer — a
